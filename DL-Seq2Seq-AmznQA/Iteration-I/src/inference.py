...
def evaluate_beam(inputs, encoder, decoder, max_length_inp, max_length_targ, word2id, id2word, units, beam_index=3):
    """
...
def evaluate(inputs, encoder, decoder, max_length_inp, max_length_targ, word2id, id2word, units):
    """
      inputs type = numpy.ndarray 
      inputs shape = (1, max_length_inp)
    """
...
def predict(encoder, decoder, random_input, max_ques_length, max_ans_length, word2id, id2word, units, beam_search=False):   
    if beam_search:
        predicted_ans, ques = evaluate_beam(random_input, encoder, decoder, max_ques_length, max_ans_length, word2id, id2word, units)
    else:
        predicted_ans, ques = evaluate(random_input, encoder, decoder, max_ques_length, max_ans_length, word2id, id2word, units)
